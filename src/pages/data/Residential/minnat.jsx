  ...
  return (
    <div className="font-sans m-0 p-0">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('/images/residential/minnat_group/Picture3.jpg')",
        }}
      ></div>
      ...
      <div className="flex flex-col px-6 md:px-12 py-12 max-w-[1200px] mx-auto bg-white shadow-lg rounded-xl mt-[-50px] relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 min-w-[300px]">
            <img
              src="/images/residential/minnat_group/Picture2.jpg"
          ...
          <div className="flex-1 flex flex-col justify-start min-w-[300px]">
            ...
            <p className="flex justify-center">
              ...
              <li>Location: Bhandup</li>
              <li>Area: 2.15 Lac Sq.Ft.</li>
              <li>Stage: Under Construction</li>
              <li>Client: Shreeji LifeSpaces & Jaydeep Group</li>
              </ul>
            </p>
          </div>
        </div>
