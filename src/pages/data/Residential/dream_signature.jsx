      ...
      <div className="flex flex-col px-6 md:px-12 py-12 max-w-[1200px] mx-auto bg-white shadow-lg rounded-xl mt-[-50px] relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 min-w-[300px]">
            <img
              src="/images/residential/dream_signature/Picture2.jpg"
          ...
          <div className="flex-1 flex flex-col justify-start min-w-[300px]">
            ...
            <p className="flex justify-center">
              ...
              <li>Location: Relief Road, Oshiwara</li>
              <li>Area: 9 Lac Sq.Ft.</li>
        ...
        <div className="mt-12">
          <img
            src="/images/residential/dream_signature/Picture4.jpg"
            alt="Additional View"
