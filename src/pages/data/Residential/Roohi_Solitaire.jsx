  ...
  return (
    <div className="font-sans m-0 p-0">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('/images/residential/roohi_solitaire/Picture3.jpg')",
        }}
      ></div>
      ...
      <div className="flex flex-col px-6 md:px-12 py-12 max-w-[1200px] mx-auto bg-white shadow-lg rounded-xl mt-[-50px] relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 min-w-[300px]">
            <img
              src="/images/residential/roohi_solitaire/Picture1.jpg"
          ...
          <div className="flex-1 flex flex-col justify-start min-w-[300px]">
           ...
           {/* Paragraph */}
            <p className="flex justify-center">
              ...
              <li>Location: Vile Parle East</li>
              <li>Area: 1.1 Lac Sq.Ft.</li>
              <li>Stage: Under Construction</li>
              <li>Client: RG Corporation</li>
              </ul>
            </p>
          </div>
        </div>
        ...
        <div className="mt-12">
          <img
            ...
            alt="Additional View"
            className="w-full h-auto max-h-[1000px] object-cover rounded-lg shadow-md hover:scale-105 transition-transform duration-300"
          />
        </div>
      </div>
    </div>
