  ...
  return (
    <div className="font-sans m-0 p-0">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('/images/residential/satara_vatsala/Picture1.jpg')",
        }}
      ></div>
      ...
      <div className="flex flex-col px-6 md:px-12 py-12 max-w-[1200px] mx-auto bg-white shadow-lg rounded-xl mt-[-50px] relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 min-w-[300px]">
            <img
              src="/images/residential/satara_vatsala/Picture1.jpg"
          ...
          <div className="flex-1 flex flex-col justify-start min-w-[300px]">
           ...
           {/* Paragraph */}
            <p className="flex justify-center">
              ...
              <li>Location: Eastern Express Highway, Chembur</li>
              <li>Area: 6 Lac Sq.Ft.</li>
              <li>Stage: Under Approval</li>
              <li>Client: Concrete Builders</li>
              </ul>
            </p>
          </div>
        </div>
