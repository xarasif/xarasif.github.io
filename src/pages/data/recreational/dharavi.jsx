  ...
  return (
    <div className="font-sans m-0 p-0">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('/images/recreational/dharavi/Picture1.jpg')",
        }}
      ></div>
      ...
      <div className="flex flex-col px-6 md:px-12 py-12 max-w-[1200px] mx-auto bg-white shadow-lg rounded-xl mt-[-50px] relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 min-w-[300px]">
            <img
              src="/images/recreational/dharavi/Picture1.jpg"
          ...
          <div className="flex-1 flex flex-col justify-start min-w-[300px]">
            ...
            <p className="flex justify-center">
              ...
              <li>Location: Dharavi</li>
              <li>Area: 1.5 Lac Sq.Ft.</li>
              <li>Stage: Refurbishing of Facade & Interiors</li>
              <li>Client: District Sports Club</li>
              </ul>
            </p>
