  ...
  return (
    <div className="font-sans m-0 p-0">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('/images/industrial/indamer/Picture3.jpg')",
        }}
      ></div>
      ...
      <div className="flex flex-col px-6 md:px-12 py-12 max-w-[1200px] mx-auto bg-white shadow-lg rounded-xl mt-[-50px] relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 min-w-[300px]">
            <img
              src="/images/industrial/indamer/Picture4.jpg"
          ...
          <div className="flex-1 flex flex-col justify-start min-w-[300px]">
            ...
            <p className="flex justify-center">
              ...
              <li>Location: MIHAN, Nagpur</li>
              <li>Area: 3 Lac Sq.Ft.</li>
              <li>Stage: Complete</li>
              <li>Client: Indamer Technics</li>
              </ul>
            </p>
          </div>
        </div>
        ...
        <div className="mt-12">
          <img
            src="/images/industrial/indamer/Picture5.jpg"
            alt="Additional View"
            className="w-full h-auto max-h-[500px] object-cover rounded-lg shadow-md hover:scale-105 transition-transform duration-300"
          /><br></br>
          <img
            src="/images/industrial/indamer/Picture6.jpg"
            alt="Additional View"
            className="w-full h-auto max-h-[500px] object-cover rounded-lg shadow-md hover:scale-105 transition-transform duration-300"
          /><br></br>
          <img
            src="/images/industrial/indamer/Picture7.jpg"
            alt="Additional View"
            className="w-full h-auto max-h-[500px] object-cover rounded-lg shadow-md hover:scale-105 transition-transform duration-300"
          />
          <br></br>
          <img
            src="/images/industrial/indamer/Picture8.jpg"
            alt="Additional View"
            className="w-full h-auto max-h-[500px] object-cover rounded-lg shadow-md hover:scale-105 transition-transform duration-300"
          />
        </div>
