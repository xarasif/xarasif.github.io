  ...
  return (
    <div className="font-sans m-0 p-0">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('/images/commercial/k_hemani/Picture1.png')",
        }}
      ></div>
      ...
      <div className="flex flex-col px-6 md:px-12 py-12 max-w-[1200px] mx-auto bg-white shadow-lg rounded-xl mt-[-50px] relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 min-w-[300px]">
            <img
              src="/images/commercial/k_hemani/Picture1.png"
          ...
          <div className="flex-1 flex flex-col justify-start min-w-[300px]">
            ...
            <p className="flex justify-center">
              ...
              <li>Location: Link Road, Andheri</li>
              <li>Area: 7.5 Lac Sq.Ft.</li>
              <li>Stage: Concept</li>
              <li>Client: K. Hemani Group</li>
              </ul>
            </p>
          </div>
        </div>
